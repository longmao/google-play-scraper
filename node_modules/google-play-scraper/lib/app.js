...
function parseFields($) {
    ...
    var whatisnew = [];
    $(".details-section.whatsnew").find(".recent-change").each(function(i) {
        whatisnew[i] = $(this).text().trim();
    });
    ...
    $('.thumbnails .screenshot').each(function(i, elem) {
        ...
        try {
            if (screenshots[i].match(/^\/\//)) {
                screenshots[i] = "https:" + screenshots[i];
            }
        } catch (e) {}

    });

    var app_category_secondary = $(".category").text().trim();
    ...
    return {
        title: title,
        icon: icon,
        app_category_secondary: app_category_secondary,
